...
import { WizardTab } from 'kestros-ui-foundation/src/js/wizard/wizard-tab'
 ...
 */
export class ValidatedWizardTab extends WizardTab {
  /**
  ...
  registerEventListeners () {
    ...
    this.containerElement.addEventListener(
      ValidatedWizard.dispatchedEvents.TAB_SUCCESS, (event) => {
        this.updateStatusIfRequested(event, this.showSuccessOnTab)
      })

    this.containerElement.addEventListener(
      ValidatedWizard.dispatchedEvents.TAB_ERROR, (event) => {
        this.updateStatusIfRequested(event, this.showErrorOnTab)
      })

    this.containerElement.addEventListener(
      ValidatedWizard.dispatchedEvents.TAB_WARNING, (event) => {
  ...
  updateStatusIfRequested (event, updateFunction) {
    if (event != null && typeof event !== 'undefined' && event.detail !==
        null &&
