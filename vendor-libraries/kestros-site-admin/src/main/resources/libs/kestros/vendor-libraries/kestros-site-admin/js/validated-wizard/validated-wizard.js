...
class ValidatedWizard extends Wizard {
  ...
  dispatchTabStatusEvent(eventName, event) {
    this.element.dispatchEvent(new CustomEvent(ValidatedWizard.dispatchedEvents.TAB_STATUS_BEFORE, event));
    this.element.dispatchEvent(new CustomEvent(eventName, event));
    this.element.dispatchEvent(new CustomEvent(ValidatedWizard.dispatchedEvents.TAB_STATUS_AFTER, event));
  }
  ...
  registerEventListeners() {
    ...
    this.element.addEventListener(ValidatedWizard.events.TAB_CONTENT_SUCCESS, e => {
      this.disableNext = false;
      this.dispatchTabStatusEvent(ValidatedWizard.dispatchedEvents.TAB_SUCCESS, e);
    });

    this.element.addEventListener(ValidatedWizard.events.TAB_CONTENT_ERROR, e => {
      this.disableNext = true;
      this.dispatchTabStatusEvent(ValidatedWizard.dispatchedEvents.TAB_ERROR, e);
    });

    this.element.addEventListener(ValidatedWizard.events.TAB_CONTENT_WARNING, e => {
      this.disableNext = false;
      this.dispatchTabStatusEvent(ValidatedWizard.dispatchedEvents.TAB_WARNING, e);
    });
   ...
   */
  selectNextTab() {
    this.element.dispatchEvent(new CustomEvent(ValidatedWizard.dispatchedEvents.VALIDATE_TAB, {
      detail: {
        wizard: this.name,
