 ...
 * Kestros Form.
 */
class Form extends InteractiveElement {
  /**
  ...
  constructor(element) {
    ...
    if (submitButtonElement !== null && typeof submitButtonElement !== 'undefined') {
  ...
  get validationMessage() {
    if (this._validationAlert === null) {
      const validationAlertElement = this.element.querySelector('.validation-message');
      if (validationAlertElement !== null && typeof validationAlertElement !== 'undefined') {
  ...
  registerEventListeners() {
    ...
    this.element.addEventListener(Form.events.FIELD_INVALID, e => {
      ...
      if (this.invalidMessage === null || typeof this.invalidMessage === 'undefined' || this.invalidMessage === '') {
        let message = '';
  ...
  submit() {
    ...
    if (this.submitPath !== null && typeof this.submitPath !== 'undefined' && this.submitPath !== '') {
      if (this.isValid) {
  ...
  submissionError(response) {
    ...
    if (response.status !== 403 && response.statusText !== null && response.statusText !== undefined && response.statusText !== '') {
