 ...
 */
export class TreeLeaf extends InteractiveElement {
  /**
   ...
   */
  get childLeaves () {
    if (this.childContainerElement !== null && typeof this.childContainerElement !==
        'undefined') {
      return this.childContainerElement.querySelectorAll(
        ':scope > .tree__leaf')
    }
    return []
  }
  ...
  get folderIcon () {
    ...
    if (this.element.dataset.folderIcon !== null &&
        typeof this.element.dataset.folderIcon !== 'undefined') {
      folderIcon = this.element.dataset.folderIcon
    } else {
      let parent = this.element.parentElement
      while (parent !== null && typeof parent !== 'undefined') {
        if (parent.dataset.folderIcon !== null &&
            typeof parent.dataset.folderIcon !==
            'undefined') {
  ...
  get standaloneIcon () {
    ...
    if (this.element.dataset.standaloneIcon !== null &&
        typeof this.element.dataset.standaloneIcon !== 'undefined') {
      standaloneIcon = this.element.dataset.standaloneIcon
    } else {
      let parent = this.element.parentElement
      while (parent !== null && typeof parent !== 'undefined') {
        if (parent.dataset.standaloneIcon !== null &&
            typeof parent.dataset.standaloneIcon !==
            'undefined') {
  ...
  activate () {
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.ACTIVATE_BEFORE))
    ...
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.ACTIVATE_AFTER))
  }
  ...
  deactivate () {
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.DEACTIVATE_BEFORE))
    this.element.classList.remove(TreeLeaf.classes.ACTIVE)
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.DEACTIVATE_AFTER))
  }
  ...
  open () {
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.OPEN_BEFORE))
    ...
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.OPEN_AFTER))
  }
  ...
  close () {
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.CLOSE_BEFORE))
    ...
    this.element.dispatchEvent(
      new CustomEvent(TreeLeaf.dispatchedEvents.CLOSE_AFTER))
  }
