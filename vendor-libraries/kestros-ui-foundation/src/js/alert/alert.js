 ...
 */
export class Alert extends InteractiveElement {
  /**
   * Constructs an Alert.
   *
  ...
  constructor (element) {
    ...
    if (!this.collapsible || this.icon.element === null ||
        typeof this.icon.element === 'undefined') {
  ...
  get collapseIcon () {
    return new InteractiveElement(
      this.element.querySelector('.alert__collapse'))
  }
  ...
  registerEventListeners () {
    ...
    if (this.icon.element !== null && typeof this.icon.element !==
        'undefined') {
    ...
    if (this.closeIcon.element !== null && typeof this.closeIcon.element !==
        'undefined') {
    ...
    if (this.collapseIcon.element !== null && typeof this.collapseIcon.element !==
        'undefined') {
