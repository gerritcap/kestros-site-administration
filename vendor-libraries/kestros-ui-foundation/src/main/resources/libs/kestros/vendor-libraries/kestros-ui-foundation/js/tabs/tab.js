...
class Tab extends TabsElement {
  ...
  setInactive() {
    if (this.isActive) {
      ...
      this.element.dispatchEvent(new CustomEvent(Tab.events.TAB_DEACTIVATED, this.eventDetails));
      document.dispatchEvent(new CustomEvent(Tab.events.TAB_DEACTIVATED, this.eventDetails));
    }
  }
}